...
{{<
  github-card
  url="https://github.com/webpack-contrib/css-loader/issues/1050?"
  title="Issue #1050 · webpack-contrib/css-loader"
  description="Interoperability across tools and support plain JS modules imports"
>}}
...
想像以上に長くなったので今回はここまで。  
次回は歌詞生成やコンポーネントの設計、404の対応、開発で苦労したことなどについてお話します。
